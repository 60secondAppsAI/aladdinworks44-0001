...
-->>
				...
				<a-menu-item>
					<router-link to="/maintenanceSchedules">
						<span class="label">Maintenance Schedules</span>
					</router-link>
				</a-menu-item>
				...
				<a-menu-item>
					<router-link to="/rackAssignments">
						<span class="label">Rack Assignments</span>
					</router-link>
				</a-menu-item>
		
				<a-menu-item>
					<router-link to="/powerSupplyAssignments">
						<span class="label">Power Supply Assignments</span>
					</router-link>
				</a-menu-item>
		
				<a-menu-item>
					<router-link to="/coolingUnitAssignments">
						<span class="label">Cooling Unit Assignments</span>
					</router-link>
				</a-menu-item>
		
				<a-menu-item>
					<router-link to="/networkSwitchAssignments">
						<span class="label">Network Switch Assignments</span>
					</router-link>
				</a-menu-item>
