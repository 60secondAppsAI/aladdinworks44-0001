						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="Model" type="text" placeholder="Enter Model" v-model="powerSupplyToAdd.model"></base-input>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Model</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Model" type="text" placeholder="Enter Model" v-model="powerSupplyDetails.model"></input>
																		</div>
						</td>
														</tr>
															<tr> 
